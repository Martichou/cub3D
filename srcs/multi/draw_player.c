...
/*   Updated: 2019/12/13 01:35:21 by marandre         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	spw->sp_x = t->multi.other->x_pos - t->player->x_pos;
	spw->sp_y = t->multi.other->y_pos - t->player->y_pos;
	...
	spw->sp_height = abs((int)(t->window.window_height / (spw->transform_y))) / 1;
	...
	spw->sp_width = abs((int)(t->window.window_height / (spw->transform_y))) / 1;
